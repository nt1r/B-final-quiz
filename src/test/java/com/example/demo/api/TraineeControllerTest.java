...
//
//import com.example.demo.dto.AddNewTraineeRequestDto;
...
//        AddNewTraineeRequestDto addNewTraineeRequestDto = AddNewTraineeRequestDto.builder().name("张三").build();
//
//        mockMvc.perform(post(addOneMemberUrl).accept(MediaType.APPLICATION_JSON)
//                .characterEncoding("UTF-8")
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(objectMapper.writeValueAsString(addNewTraineeRequestDto)))
...
//        AddNewTraineeRequestDto addNewTraineeRequestDto = AddNewTraineeRequestDto.builder().name("").build();
//
//        mockMvc.perform(post(addOneMemberUrl).accept(MediaType.APPLICATION_JSON)
//                .characterEncoding("UTF-8")
//                .contentType(MediaType.APPLICATION_JSON)
