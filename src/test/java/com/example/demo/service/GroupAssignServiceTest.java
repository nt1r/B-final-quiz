...
//        // Given
//        AddNewTraineeRequestDto addNewTraineeRequestDto = AddNewTraineeRequestDto.builder()
//                .name("张三")
//                .build();
//
//        // When
//        List<TraineeDto> allMemberListList = groupService.addOneMember(addNewTraineeRequestDto);
//
//        // Then
